...
function Home() {
    ...
    async function adicionarComentario(idPostagem, comentarioTexto) {
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                setComentarios((prevComentarios) => [...prevComentarios, data.comentario]);
            }
        } catch (error) {
        ...
        <div className={styles.container}>
            ...
            <header className={styles.header}>
                ...
                <div className={styles.headerRight}>
                    ...
                    <div className={styles.userInfo}>
                        ...
                        <img src={dados?.foto_perfil || '/default-profile.jpg'} alt="Foto de Perfil" className={styles.profileImage} />
            ...
            {isCardVisible && (
                <div className={styles.dropdownCard}>
                    ...
                    <div className={styles.cardOption} onClick={() => { alert('Você está saindo da sua conta'); navigate('/Login'); }}>Sair</div>
                </div>
            )}
                    ...
                    {postagens.map((postagem) => (
                        <div key={postagem.id} className={styles.cardPostagem}>
                            ...
                            <div className={styles.cardButtonsContainer}>
                                ...
                                <button className={styles.cardButton} onClick={() => setComentarioAberto(postagem.id)}>
                                    <FaComment />
                                </button>
                            </div>

                            {comentarioAberto === postagem.id && (
                                <div className={styles.comentariosChat}>
                                    ...
                                    <div className={styles.comentarioInput}>
                                        <textarea value={novoComentario} onChange={(e) => setNovoComentario(e.target.value)} placeholder="Digite seu comentário..." />
